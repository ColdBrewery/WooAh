        ...
        <SafeAreaView className="flex-1 bg-white" style={{backgroundColor: themeColors.bg}}>
            <SafeAreaView className="flex">
                ...
                <View className={'flex-row justify-center'}>
                    <Image source={require('../assets/png/catwoman.png')} style={{width: 250, height: 250}}/>
                </View>
            </SafeAreaView>
            {/*whitebox*/}
            ...
            <View className={'form space-y-2'}>
                ...
                >
                    <Text className={'text-base font-bold text-center text-gray-700'}>Login</Text>
                </TouchableOpacity>
            </View>
                ...
                <View className="flex-row justify-center mt-7 p-6">
                    ...
                    <TouchableOpacity onPress={()=> navigation.navigate('SignUp')}>
                        <Text className="font-semibold text-cyan-900"> Sign Up </Text>
                    </TouchableOpacity>
                </View>
                </ScrollView>
            </View>
